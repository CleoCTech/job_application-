            ...
            <div id="wizard_container" class="wizard" novalidate="novalidate">
                ...
                <div class="step wizard-step mybox" data-state="branchtype">
                    ...
                    <div class="form-group">
                        <label class="">
                            <input type="text" name="job-title" id="id" style="width:400px !important;" class="form-control required fl-input"
                                placeholder="Job Title">
                            <br>
                            <input type="text" name="work_place" id="id" style="width:400px !important;"
                                class="form-control required fl-input" placeholder="Company/Organization/Institution">
                            <br>
                            ...
                            <textarea class="form-control required fl-input" name="job_roles" rows="5" id="roles"
                                style="width:400px !important;" placeholder="Roles"></textarea>
